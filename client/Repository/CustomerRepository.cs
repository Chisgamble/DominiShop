...
{
    public class CustomerRepository(PostgresContext context)
    {
        ...
        public async Task<Customer> Insert(Customer item)
        {
            ...
            catch (DbUpdateException ex)
            {
                ...
                if (msg.Contains("customer_username_key"))
                    throw new Exception($"Username '{item.Username}' is already taken.");
